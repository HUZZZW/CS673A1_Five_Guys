<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="Picture:" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item label="Attribute Details:">
    ...
    methods: {
      ...
      handleAddProductAttrValue(idx) {
        ...
        if (options.indexOf(this.addProductAttrValue) !== -1) {
          this.$message({
            message: 'Attribute value cannot repeat',
            type: 'warning',
            duration: 1000
          });
          return;
      ...
      handleRefreshProductSkuList() {
        this.$confirm('Confirm refresh', 'Notice', {
      ...
      handleSyncProductSkuPrice(){
        this.$confirm('Sync the first price to all price, Confirm operation', 'Notice', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      handleSyncProductSkuStock(){
        this.$confirm('Sync the first inventory to all inventory, Confirm operation', 'Notice', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
