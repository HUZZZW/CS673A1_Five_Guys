  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="Search: ">
            <el-input style="width: 203px" v-model="listQuery.keyword" placeholder=""></el-input>
          </el-form-item>
          <el-form-item label="Product Name: ">
            <el-input style="width: 203px" v-model="listQuery.productSn" placeholder=""></el-input>
          </el-form-item>
          ...
          <el-form-item label="Brand: ">
            <el-select v-model="listQuery.brandId" placeholder="Select" clearable>
              <el-option
    ...
    <div class="table-container">
      <el-table ref="productTable"
        ...
        <el-table-column label="Price/Number" width="120" align="center">
          <template slot-scope="scope">
            <p>Price: ${{scope.row.price}}</p>
            <p>Number:{{scope.row.productSn}}</p>
          </template>
        </el-table-column>
        ...
        <!-- <el-table-column label="Audit Status" width="100" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button
                type="text"
                @click="handleShowVerifyDetail(scope.$index, scope.row)">Audit Detail
              </el-button>
            </p>
          </template>
        </el-table-column> -->
        <el-table-column label="Operation" width="160" align="center">
          <template slot-scope="scope">
            <p>
              <!-- <el-button
                size="mini"
                @click="handleShowProduct(scope.$index, scope.row)">Detail
              </el-button> -->
              <el-button
                size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      handleEditSkuConfirm(){
        ...
        this.$confirm('Confirm Edition', 'Notice', {
      ...
      handleBatchOperate() {
        ...
        this.$confirm('Confirm batch operation?', 'Notice', {
