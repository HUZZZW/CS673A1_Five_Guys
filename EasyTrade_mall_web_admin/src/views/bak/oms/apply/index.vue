  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Dispose Status">
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="Apply time" width="180" align="center">
          <template slot-scope="scope">{{scope.row.createTime | formatTime}}</template>
        </el-table-column>
        <el-table-column label="User" align="center">
          <template slot-scope="scope">{{scope.row.memberUsername}}</template>
        </el-table-column>
        <el-table-column label="Amount" width="180" align="center">
        ...
        <el-table-column label="Dispose time" width="180" align="center">
    ...
    methods:{
      ...
      handleBatchOperate(){
        if(this.multipleSelection==null||this.multipleSelection.length<1){
          this.$message({
            message: 'Please choose applications',
            type: 'warning',
            duration: 1000
          });
          return;
