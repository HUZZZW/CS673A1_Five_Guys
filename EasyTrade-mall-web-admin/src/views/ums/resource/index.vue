<template> 
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Path:">
            <el-input v-model="listQuery.urlKeyword" class="input-width" placeholder="Path" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <el-button size="mini" class="btn-add" @click="handleShowCategory()">Resource Allocation</el-button>
    </el-card>
