  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrTable"
        ...
        <el-table-column label="Selection" width="120" align="center">
          <template slot-scope="scope">{{scope.row.selectType|selectTypeFilter}}</template>
        </el-table-column>
        <el-table-column label="Input Mode" width="150" align="center">
          <template slot-scope="scope">{{scope.row.inputType|inputTypeFilter}}</template>
        </el-table-column>
        <el-table-column label="Available Values" align="center">
    ...
    methods: {
      ...
      handleBatchOperate() {
        if (this.multipleSelection < 1) {
          this.$message({
            message: 'Please choose one attribute',
            type: 'warning',
            duration: 1000
          });
          return;
        ...
        if (this.operateType !== 'deleteProductAttr') {
          this.$message({
            message: 'Please choose batch operation',
            type: 'warning',
            duration: 1000
          });
          return;
