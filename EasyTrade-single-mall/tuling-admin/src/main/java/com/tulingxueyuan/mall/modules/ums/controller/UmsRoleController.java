...
/**
 * Back-end user role management
 * Created by macro on 2018/9/30.
 */
@Controller
@Api(tags = "UmsRoleController", description = "Back-end user role management")
@RequestMapping("/role")
public class UmsRoleController {
    ...
    @ApiOperation("Batch deleting roles")
    ...
    @ApiOperation("Paging gets a list of roles based on their name")
    ...
    @ApiOperation("Modifying role status")
    ...
    @ApiOperation("Gets the role-related menu")
    ...
    @ApiOperation("Obtain role-related resources")
    ...
    @ApiOperation("Allocate resources to roles")
